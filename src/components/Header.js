        ...
        <div className="flex flex-stretch items-center">
          ...
          <div className="w-auto">
            <ul
              ...
              id="menu"
            >
              <li className="mx-3 py-10 md:py-0">
                <Link to="/mypokemon" className={`text-black ${mode === 'light' ? 'md:text-white' : 'md:text-black'} hover:underline`}
                  >My Pokemon</Link
                >
              </li>
            </ul>
          ...
          <div className="w-auto">
            <ul className="items-center flex">
              ...
              <li className="ml-6">
                <Link
                  id="header-cart"
                  className={`flex items-center justify-center w-8 h-8 text-black ${mode === 'light' ? 'md:text-white' : 'md:text-black'}`}
                  to="/cart"
                >
                  <svg
                    className="fill-current"
